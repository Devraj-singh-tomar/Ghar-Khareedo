            ...
            {listing && !loading && !error && (
                <>
                    ...
                    <div className='flex flex-col max-w-4xl mx-auto p-3 gap-4'>
                        ...
                        <ul className='flex flex-wrap item-center gap-4 sm:gap-6 text-green-900 font-semibold text-sm'>
                        ...
                        {currentUser && listing.userRef !== currentUser._id && !contact && (
                            <button onClick={() => setContact(true)} className="bg-slate-700 p-1 text-white rounded-lg uppercase hover:opacity-95 ">Contact landlord</button>
                        )}
